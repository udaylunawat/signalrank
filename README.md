...
```bash
python build_corpus.py --user example
python build_faiss_corpus.py --user example
python rank_corpus.py --user example --use-case default
```
---
...
cat << 'EOF' > ~/Library/LaunchAgents/com.example.job_ranker.scheduler.plist
<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "[http://www.apple.com/DTDs/PropertyList-1.0.dtd](http://www.apple.com/DTDs/PropertyList-1.0.dtd)">
<plist version="1.0">
<dict>
  <key>Label</key>
  <string>com.example.job_ranker.scheduler</string>
  <key>ProgramArguments</key>
  <array>
    <string>/usr/local/bin/python3</string>
    <string>/Users/examplecandidate/Projects/job_ranker/scrape_jobs/scheduler.py</string>
  </array>
  <key>RunAtLoad</key>
  <true/>
  <key>KeepAlive</key>
  ...
  <string>/Users/examplecandidate/Projects/job_ranker/scrape_jobs</string>
  <key>StandardOutPath</key>
  <string>/Users/examplecandidate/job_ranker_launchd.out</string>
  <key>StandardErrorPath</key>
  <string>/Users/examplecandidate/job_ranker_launchd.err</string>
</dict>
</plist>
EOF

launchctl load ~/Library/LaunchAgents/com.example.job_ranker.scheduler.plist
```
...
launchctl unload ~/Library/LaunchAgents/com.example.job_ranker.scheduler.plist
launchctl load ~/Library/LaunchAgents/com.example.job_ranker.scheduler.plist
```
...
# Test a full run
python cli.py run --resume users/Example_Candidate/resume.tex --search "mlops engineer" --user example --profile senior_ic --country India
